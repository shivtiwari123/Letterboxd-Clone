import { Container, Flex, Grid, Heading, Select, Skeleton, Text } from "@chakra-ui/react"
  ...
  return (
    <Container maxW={"container-xl"}>
      <Flex alignItems={"baseline"} gap={"4"} my="10">
        <Heading color={"white"} as="h2" fontSize={"md"} textTransform={"uppercase"}>Discover TV Shows</Heading>
        <Select backgroundColor={"gray.500"} w={"130px"} onChange={(e) => {
          setActivePage(1);
