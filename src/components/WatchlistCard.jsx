    ...
    return (
      <Link to={`/${type}/${item.id}`}>
        <Flex gap="4">
          ...
          <Box>
            <Heading color={"white"} fontSize={{base: 'xl', md: "2xl"}} noOfLines={1}>
            ...
            <Flex alignItems={"center"} gap={2} mt="4">
              ...
              <Text color={"white"} textAlign={"center"} fontSize="small">
                {item?.vote_average?.toFixed(1)}
              </Text>
            </Flex>
            <Text color={"white"} mt="4" fontSize={{base: "xs", md: "sm"}} noOfLines={5}>
              {item?.overview}
            </Text>
          </Box>
        </Flex>
