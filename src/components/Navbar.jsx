import {Avatar, Button, Box, Container, Drawer, DrawerCloseButton, DrawerContent, DrawerHeader, DrawerBody, DrawerOverlay, Flex, IconButton, Menu, MenuButton, MenuItem, MenuList, useDisclosure } from "@chakra-ui/react"
    ...
    <Box py="4" mb="2">
        <Container maxW={'container.xl'}>
            <Flex justifyContent={"space-between"}>
                ...
                <Flex color={"gray.100"} gap="3" alignItems={"center"} display={{base: "none", md: "flex"}}>
                    <Link to="/">Home</Link>
          ...
          >
            ...
            <Drawer isOpen={isOpen} placement="right" onClose={onClose}>
              ...
              <DrawerContent bg={"black"}>
                ...
                <DrawerBody>
                  <Flex color={"white"} flexDirection={"column"} gap={"4"} onClick={onClose}>
                    <Link to="/">Home</Link>
                    <Link to="/movies">Movies</Link>
